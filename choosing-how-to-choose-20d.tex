...
{\color{blue}
	...
	Just as with E-Admissibility, the defender of Maximality will argue that one shouldn't select by randomisation (at least when your opinions are as described above), and also shouldn't have uncertainty over how one picks in a way which amounts to randomisation. 
	Instead, you should coordinate how you resolve incomparability. 
