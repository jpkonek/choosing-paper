...
{\color{orange}
	...
	{\color{blue}
		What this example highlights is the close connection between the analysis of this paper and existing challenges and discussions for these theories. Whilst our formal results are very closely related: any such Dutch book or sequential choice challenge can be seen as a case where one is unsure which decision problem you'll be faced with, taking them each as equally likely, and evaluating strategies. However, the philosophical point we are making is different. 
	}
