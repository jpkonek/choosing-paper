...
{\color{green}
	This example is closely related to another phenomenon: Dutch books or paradoxes of sequential choice, which can be constructed against agents on the basis of such examples \citep{seidenfeld2004contrast,elga2010sp}. \todoinfo{REFS!!!!}
