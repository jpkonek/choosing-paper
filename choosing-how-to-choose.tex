...
And, most importantly, the arguments in favour of the axioms that characterize them---which, in many cases, constitute the arguments for the theory itself---never make reference to the sort of decision you'll face: if they are plausible at all, they are plausible as applied to all decisions. \todo{Could we make a mixed decision, to show why the risk profile couldn't change?} 
