...
\end{array}
$$ she will prefer Risky-sweetened to Safe; but for some small enough sweetening, it is plausible that she will still prefer 1A to 1B-sweetened (an Archimadeanicity principle)
$$
\begin{array}{r|cccc}
	& \text{ticket 1} &\text{ticket 2-11}& \text{ticket 12-100}\\
	\hline
