...
\begin{proof}
	...
	\begin{proof}
		...
		Then $\mu^*(C_2\setminus E_1)\geq\alpha-\frac{\alpha}{k}>\frac{\alpha}{k}$ so we can choose $E_2\subseteq C_2\setminus E_1$ with $\mu^*(E_2)=\frac{\alpha}{k}$. 
		
		Then $\mu^*(C_3\setminus(E_1\cup E_2))\geq\alpha-2\frac{\alpha}{k}> \frac{\alpha}{k}$ so we can choose $E_3\subseteq C_3\setminus (E_1\cup E_2)$ with $\mu^*(E_3)=\frac{\alpha}{k}$. 
