...
\begin{definition}\ 
	\begin{itemize}
		...
		\item $\Uwald$ is \emph{Bayes-continuous} iff, for all $o\in\O$, if $o$ is Bayes for $p$ and $p_1,p_2,\ldots$ are probabilities converging to $p$ then there is some sequence of options $o_1,o_2,\ldots$, with $o_n$ Bayes for $p_n$, whose utility profiles converge to those of $o$. 
	\end{itemize}
\end{definition}
