...
The formal motivation for our investigation was instead \citet{levinstein2017pgeu} who, following \citet{schervish2009psr}, also considers evaluations based on uncertainty over which decision problem is being faced, although his analysis is to evaluate credences according to their expected guidance value in each state of the world, which differs from ours by both associated a picking function with varying credences in accordance with expected utility theory and then reduces it using expectations. 
\end{colored}
...
\todo{let's do a final double check of this again}
\begin{colored}
