...
%\renewcommand\S{\mathsf{PickingStrategies}}
...
$$
The empirically observed preferences are $\text{1A} \succ \text{1B}$ and $\text{2A} \prec \text{2B}$. 
Let's suppose that our agent has a decision theory which endorses these preferences, given the parameters such as her credences and utilities.
