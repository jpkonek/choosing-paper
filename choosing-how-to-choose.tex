...
\begin{colored}
	{violet}
	\subsubsection{Change the way of updating credences}
\todo{RP: I added a tiny bit here, and I think we should keep.}
...
Since $\Gamma$-Maximin is a more restrictive theory than Maximality, for a strategy to be $\Gamma$-Maximin there must be some $p\in\IP$ for which it $\mu^*$ surely picks for
