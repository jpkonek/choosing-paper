...
\begin{proof}
	...
	Define $\phi$ a measurable correspondence from $\Decs$ to $\A$ by $\phi(D)=D$. It is weakly measurable, i.e., for $U$ open $\subseteq\A$, $\{D\given U\cap D\neq\emptyset\}$ is measurable (in fact, open) in $\Decs$ \citep[3.91]{aliprantis2006infinite}.
