...
%		P &  \sfrac{1}{11} \times \sfrac{11}{100} & \sfrac{10}{11}\times\sfrac{11}{100} & \sfrac{89}{100} \\
	...
	In scenario 2, whilst you recommend that she takes the risky option when deciding at that point, you think it would be better if she listened to a different financial advisor, one who recommends taking the safe option. 
