...
\begin{colored}{violet}\todo{!!!}
The formal motivation for our investigation was instead \citet{levinstein2017pgeu} who, following \citet{schervish2009psr}, also considers uncertainty over which decision problem is being faced and makes evaluations on that basis. 
The target of their investigation is to judge credences rather than decision theories.
They hold fixed the decision theory as expected utility theory and instead using this uncertainty over which decision you'll face to evaluate credences by their guidance value, assuming what they guide you to do is in accordance with expected utility theory. 
...
\todo{do we want to change this?? I don't thinkit's terrible as is... }
