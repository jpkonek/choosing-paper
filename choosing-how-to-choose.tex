...
\begin{proof}
	...
	\end{sublemma}
	\begin{proof}
		This uses the atomlessness. Put $\alpha=\min\{\mu^*(C_1),\ldots,\mu^*(C_k)\}$. 
		
		Choose $E_1\subseteq C_1$ with $\mu^*(E_1)\leq \frac{\alpha}{k}$. So that $\mu^*(C_2\setminus E_1)\geq\alpha-\frac{\alpha}{k}\geq\frac{\alpha}{k}$.
		
		Then choose $E_2\subseteq C_2\setminus E_1$ with $\mu^*(E_2)\leq\frac{\alpha}{k}$. So that $\mu^*(C_3\setminus(E_1\cup E_2))\geq\alpha-2\frac{\alpha}{k}\geq \frac{\alpha}{k}$.   
		And so on.
	\end{proof}
