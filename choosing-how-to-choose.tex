...
{\color{violet}\todoinfo{CCM playing with rewriting.}
	...
	You need to offer your client advice about how to choose between two options, a risky one and a safe one. Let's say the risky one depends on some particular outcome, say whether the market crashes. Let's suppose that you think the odds of the market crashing are $1:10$. 
	...
	Now suppose that you think that the client is only possibly going to be offered this opportunity in the morning, let's say your credence is $11\%$. And otherwise she just gets nothing. 
	...
	We can put this as advising your client over whether she should follow your own recommendations -- to take the gamble -- or to follow another financial advisor's recommendations, one who recommends sticking with the safe option. 
...
%		P &  \sfrac{1}{11} \times \sfrac{11}{100} & \sfrac{10}{11}\times\sfrac{11}{100} & \sfrac{89}{100} \\
	...
	What this means as a financial advisor is that if you are in Scenario 2, you are recommending to your client that if she is offered the option to choose, she should select the safe one. 
	However, if she is able to ring you up in the morning and inform you that she has been offered it, you now switch your recommendation and say she should take the risky option. Although, there is a sense in which you're advising her not to do that.
	
	In scenario 2, whilst you recommend that she takes the risky option when the decision is in play, you think it would be better if she listened to a different financial advisor, one who recommends taking the safe option. 
