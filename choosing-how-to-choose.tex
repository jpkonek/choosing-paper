...
Now, instead consider this decision problem. It has two options, a risky bet and a safe option which depend on, lets say, whether this particular company goes bust. The options might be, for example, options for stocks she can invest in. Let's suppose that the agent thinks that the odds of this company going bust are $1:10$. 
...
Or perhaps she has to choose a proxy to act on her behalf, knowing what they'll pick in each decision problem, but unsure which decision problem will be in play. For example, she is about to go into an operation and will be under anaesthetic when a decision might need to be made. 
...
That is, she should want to instruct her stockbroker to take the Safe option if these are the offers, and select a proxy who will pick the Safe course of action. 
...
This shows that any decision theory which permits the sweetened Allais preferences is self-undermining. 
