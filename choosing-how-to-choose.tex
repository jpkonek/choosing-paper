...
\begin{proposition}\label{thm:max-nu-suff}
		If for some $p\times\mu\in \IB$, $\nu$ $\mu$-surely picks for $\EU_{p}$, then $\nu\in\Maximality_\IB(\N)$. 
		
		More generally, if for some $\pb\in \IB$, $\nu$ $\mu$-surely picks for $\EU_{\pb(\cdot|-)}$, then $\nu\in\Maximality_\IB(\N)$. 
\end{proposition}
